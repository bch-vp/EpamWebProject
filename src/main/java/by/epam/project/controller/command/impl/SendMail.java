...
public class SendMail implements Command {
    ...
    public Router execute(HttpServletRequest request) {
        String emailSubjectWithLocale = ContentUtil.getWithLocale("ru", PropertiesMessage.EMAIL_SUBJECT);
        String emailBodyWithLocale = ContentUtil.getWithLocale("ru", PropertiesMessage.EMAIL_BODY);
