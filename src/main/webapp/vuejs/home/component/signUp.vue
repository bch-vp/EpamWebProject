    ...
    return {
      ...
      rules: {
        login: [
          ...
          v => (v.length >= 3) || this.text_page.sign_up_component.login.error.min_length,
        ...
        password: [
          ...
          v => (v.length >= 5) || this.text_page.sign_up_component.password.error.min_length,
          v => (v.length <= 20) || this.text_page.sign_up_component.password.error.max_length,
        ...
        first_name: [
          ...
          v => (v.length >= 3) || this.text_page.sign_up_component.first_name.error.min_length,
          v => (v.length <= 15) || this.text_page.sign_up_component.first_name.error.max_length,
        ...
        last_name: [
          ...
          v => (v.length >= 3) || this.text_page.sign_up_component.last_name.error.min_length,
          v => (v.length <= 15) || this.text_page.sign_up_component.last_name.error.max_length,
        ...
        telephoneNumber: [
          ...
          v => (v.length <= 17) || this.text_page.sign_up_component.telephone_number.error.max_length,
        ...
        email: [
          ...
          v => (v.length <= 55) || this.text_page.sign_up_component.email.error.max_length,
