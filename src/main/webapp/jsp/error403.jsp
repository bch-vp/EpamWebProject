...
<script>
    let text_page = {
        error_component: {
            error: {
                title: "<fmt:message key="error_component.error403.title"/>",
                text: "<fmt:message key="error_component.error403.text"/>",
                button: "<fmt:message key="error_component.error403.button"/>",
            }
